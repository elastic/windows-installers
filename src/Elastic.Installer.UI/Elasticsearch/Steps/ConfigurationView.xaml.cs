...
namespace Elastic.Installer.UI.Elasticsearch.Steps
{
	...
	public partial class ConfigurationView : StepControl<ConfigurationModel, ConfigurationView>
	{
		...
		private class IntToDoubleConverter : IBindingTypeConverter
		{
		...
		private class NullableDoubleToIntConverter : IBindingTypeConverter
		{
			public int GetAffinityForObjects(Type fromType, Type toType) => 1;
		...
		private class NullableDoubleToNullableIntConverter : IBindingTypeConverter
		{
			public int GetAffinityForObjects(Type fromType, Type toType) => 1;
		...
		private class NullableIntToNullableDoubleConverter : IBindingTypeConverter
		{
			public int GetAffinityForObjects(Type fromType, Type toType) => 1;
