...
{
	public class KibanaInstallPluginsAction : CustomAction<Kibana>
	{
		public override string Name => nameof(KibanaInstallPluginsAction);
		...
		public override Step Step => new Step(nameof(KibanaInstallConfigurationAction));
		public override Execute Execute => Execute.deferred;

		[CustomAction("KibanaInstallPlugins")]
		public static ActionResult KibanaInstallPlugins(Session session) =>
