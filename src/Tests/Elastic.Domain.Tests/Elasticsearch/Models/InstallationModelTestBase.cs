...
namespace Elastic.Installer.Domain.Tests.Elasticsearch.Models
{
	...
	{
		protected string VersionSpecificInstallDirectory => Path.Combine(
			LocationsModel.DefaultProductInstallationDirectory, TestSetupStateProvider.DefaultTestVersion);
